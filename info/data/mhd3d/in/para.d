...
#hyper dissipation coefficient + exp+ hyper dissipation coefficient +exp
0	0	0	0
...
U.Tfinal 	0.1
U.Tdt		0.001	
U.Tdiag_basic_init	0.001
U.Tdiag_advanced_init	0.001
U.Tstructure_fn_start	10.0


(1)U.Tglobal_save  		0.01
(2)U.Tfield_save		5
(3)U.Tfield_frequent_save 	5
(4)U.Tfield_reduced_save	5
(5)U.Trealfield_save  		10
(6)U.Tfield_k_save		10
(7)U.Tfield_r_save		10
(8)U.Tspectrum_save 		1
(9)U.Tpressure_spectrum_save 	100
(10)U.Tflux_save		0.0001
...
(1)input-meta-para(int,float,string)		1	8	1
(2)input-para-int:field_input_proc,N_in_reduceced	6	
(3)input-para-float		0.1  0.1 0.4  0.5 0.1
(4)input-para-string		TEST


(1)force-meta-para(int,float,string)		1	4	1
(2)force-para-int:field_input_para,N_in_reduceced	0
(3)force-para-float		3  5   0.07  0
