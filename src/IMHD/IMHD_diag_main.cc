...
//	 
	...
	while (diagnostic_procedure(i) < MY_MAX_INT)
	{
		...
		{		
			case (0) : U.Output_global(W);		break;					
			case (1) : U.Output_shell_spectrum(W); break;	
			case (2) : U.Output_ring_spectrum(W);  break;			
			case (3) : U.Output_cylinder_ring_spectrum(W);  break;
			case (4) : U.Compute_force(W); U.Output_flux(W);		break;
			// force reqd for force-feed calculations
			case (5) : U.Output_shell_to_shell(W); break;
			case (6) : U.Output_cylinder_ring_to_ring(W);  break;		
			case (7) : U.Output_structure_fn(W);  break;
			case (8) : U.Output_planar_structure_fn(W);  break;
			case (9) : U.Output_moment(W);  break;
			case (10) : U.Output_field_k(W);  break;
			case (11) : U.Output_field_r(W);  break;
			case (12) : U.Output_Skpq(W);  break;
			case (13) : U.Output_realfield(W);  break;
			case (14) : U.Output_field_reduced(W); break;
		}	
