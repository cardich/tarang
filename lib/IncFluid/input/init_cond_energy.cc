 ...
 *			Parameters epsilon = (*init_cond_double_para)(1).
 *
...
/*	Model_initial_shell_spectrum(N, *CV_shell_ek, (*init_cond_double_para)(1),
									 (*init_cond_double_para)(2), 
									 (*init_cond_double_para)(3),
									 (*init_cond_double_para)(4)); */
 
	Model_initial_shell_spectrum_Pope(*CV_shell_ek, (*init_cond_double_para)(1));
...
/** @brief Create initial condition based on given spectrum Sk(k). 
 *			Parameters: For velocity field eps_u = init_cond_para(1).
 *						For scalar field eps_T = init_cond_para(2).
 *
 * @note  The energy Sk(k) is divided equally among all the modes in the shell.
...
/*	Model_initial_shell_spectrum(N, *CV_shell_ek, (*init_cond_double_para)(1),
	...
	Model_initial_shell_spectrum(N, *T.CS_shell_ek, (*init_cond_double_para)(5),
									 (*init_cond_double_para)(6), 
									 (*init_cond_double_para)(7),
									 (*init_cond_double_para)(8));  */
	
	Model_initial_shell_spectrum_Pope(*CV_shell_ek, (*init_cond_double_para)(1));
	T.Model_initial_shell_spectrum_Pope(*T.CS_shell_ek, (*init_cond_double_para)(2));
...
void  IncFluid::Init_cond_energy_spectrum_RB(IncSF& T)
{
	...
	/*	Model_initial_shell_spectrum(N, *T.CS_shell_ek, (*init_cond_double_para)(1),
		...
		T.Model_initial_shell_spectrum_Pope(*CS_shell_ek, (*init_cond_double_para)(1));
...
/** @brief Create initial condition based on given spectrum Sk(k). 
 *			Parameters: For velocity field eps_u = init_cond_para(1).
 *						For W field eps_W = init_cond_para(2).
 *
 * @note  The energy Sk(k) is divided equally among all the modes in the shell.
...
/*	Model_initial_shell_spectrum(N, *CV_shell_ek, (*init_cond_double_para)(1),
	...
	Model_initial_shell_spectrum(N, *W.CV_shell_ek, (*init_cond_double_para)(5),
										(*init_cond_double_para)(6), 
										(*init_cond_double_para)(7),
										(*init_cond_double_para)(8));  */
	
	Model_initial_shell_spectrum_Pope(*CV_shell_ek, (*init_cond_double_para)(1));
	W.Model_initial_shell_spectrum_Pope(*W.CV_shell_ek, (*init_cond_double_para)(2));
...
/** @brief Create initial condition based on given spectrum Sk(k). 
 *			Parameters: For velocity field eps_u = (*init_cond_double_para)(1).
 *						For W field eps_W = (*init_cond_double_para)(2).
 *						For T field eps_T = (*init_cond_double_para)(3).
 *
 * @note  The energy Sk(k) is divided equally among all the modes in the shell.
...
/*	Model_initial_shell_spectrum(N, *CV_shell_ek, (*init_cond_double_para)(1),
	...
	Model_initial_shell_spectrum(N, *T.CS_shell_ek, (*init_cond_double_para)(9),
										(*init_cond_double_para)(10), 
										(*init_cond_double_para)(11),
										(*init_cond_double_para)(12));  */
	
	Model_initial_shell_spectrum_Pope(*CV_shell_ek, (*init_cond_double_para)(1));
	W.Model_initial_shell_spectrum_Pope(*W.CV_shell_ek, (*init_cond_double_para)(2));
	T.Model_initial_shell_spectrum_Pope(*T.CS_shell_ek, (*init_cond_double_para)(3));
 ...
 */
	...
	DP sk = (*init_cond_double_para)(2);  // sk = Hk/(k*ek) = IC(2)
...
/*	Model_initial_shell_spectrum(N, *CV_shell_ek, (*init_cond_double_para)(1),
	...
	DP skW = (*init_cond_double_para)(10);			// = HM(k) * k / EW(k)
	h = (*init_cond_double_para)(11);				// = 2*Hc/(amp*ampW)  */
	...
	// for W field
	W.Model_initial_shell_spectrum_Pope(*W.CV_shell_ek, (*init_cond_double_para)(3));
...
/*	Model_initial_shell_spectrum(N, *T.CS_shell_ek, (*init_cond_double_para)(9),
	...
	T.Model_initial_shell_spectrum_Pope(*CS_shell_ek, (*init_cond_double_para)(6));
