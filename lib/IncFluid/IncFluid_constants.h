...
const int MAXSIZE_SWITCHES_ARRAY = 40;
...
const int MAXSIZE_INIT_COND_META_PARA = 30;
const int MAXSIZE_INIT_COND_INT_PARA = 30;
const int MAXSIZE_INIT_COND_DOUBLE_PARA = 30;
const int MAXSIZE_INIT_COND_STRING_PARA = 10;

const int MAXSIZE_FORCE_META_PARA = 30;
const int MAXSIZE_FORCE_INT_PARA = 30;
const int MAXSIZE_FORCE_DOUBLE_PARA = 30;
