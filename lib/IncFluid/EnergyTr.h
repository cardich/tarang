...
/*	int				no_of_Skpq_triads;
	...
	Array<DP,1>  *forceW_shell;					// fW(k)*W(k)
	...
	Array<DP,2>  *forceW_ring;					// fW(k)*u(k)
	
	// Cylinderical ring to ring
	Array<DP,4>  *cylinder_ring_to_ring_VF_WtoW;		// from W to W
	Array<DP,4>  *cylinder_ring_to_ring_VF_UtoW;		// from U to W
	Array<DP,4>  *cylinder_ring_to_ring_Elsasser_plus;	// from Zplus to Zplus
	Array<DP,4>  *cylinder_ring_to_ring_Elsasser_minus;	// from Zminus to Zminus
	
	Array<DP,2>  *forceW_cylinder_ring;			// fu(k)*u(k)
