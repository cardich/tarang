	...
	if (my_id == master_id)
		...
		{	
			flux_file << i << " " << (*sphere_radius)(i) << " "  
						...
						<< (*flux_VF_Win_Uout)(i)		<< " "		
						<< (*flux_VF_Uout_Wout)(i)		<< "    " 
						<< (*flux_Elsasser_plus)(i)		<< " "		
						<< (*flux_Elsasser_minus)(i)	<< "    "
						<< (*forceV_shell)(i)			<< " "		
						<< (*forceW_shell)(i)			<< "    ";
...
void IncFluid::Output_shell_to_shell(IncVF& W)
{
	...
	if (my_id == master_id)
	{
		...
		shell_to_shell_file << "%% W to W: "			<< endl 
				<< (*shelltoshell_VF_WtoW)(ra,ra2)		<< endl;
		
		shell_to_shell_file << "%% U to W: "			<< endl 
				<< (*shelltoshell_VF_UtoW)(ra,ra2)			<< endl;
		
		shell_to_shell_file << "%% Zp to Zp: "			<< endl 
				<< (*shelltoshell_Elsasser_plus)(ra,ra2)		<< endl;
		
		shell_to_shell_file << "%% Zm to Zm: "			<< endl 
				<< (*shelltoshell_Elsasser_minus)(ra,ra2) 
				<< endl << endl << endl;
...
void IncFluid::Output_shell_to_shell(IncVF& W, IncSF& T)
{
	...
	if (my_id == master_id)
	{
		...
		shell_to_shell_file << "%% Zm to Zm: "			<< endl 
				<< (*shelltoshell_Elsasser_minus)(ra,ra2)	<< endl;
	...
	if (ET_anisotropic_ring_switch == 1)
	{
		...
		if (my_id == master_id)
		{
			...
			ring_to_ring_file << "%% W to W: "						<< endl 
				<< (*ring_to_ring_VF_WtoW)(ra1,ra2,ra1,ra2)			<< endl;
			
			ring_to_ring_file << "%% U to W: "						<< endl 
				<< (*ring_to_ring_VF_UtoW)(ra1,ra2,ra1,ra2)				<< endl;
			
			ring_to_ring_file << "%% Zp to Zp: "					<< endl 
				<< (*ring_to_ring_Elsasser_plus)(ra1,ra2,ra1,ra2)		<< endl;
			
			ring_to_ring_file << "%% Zm to Zm: "					<< endl 
				<< (*ring_to_ring_Elsasser_minus)(ra1,ra2,ra1,ra2)		<< endl << endl;
...
void IncFluid::Output_ring_to_ring(IncVF& W, IncSF& T)
{
	...
	if (ET_anisotropic_ring_switch == 1)
	{
		...
		if (my_id == master_id)
		{
			...
			ring_to_ring_file << "%% Zm to Zm: "						<< endl 
				<< (*ring_to_ring_Elsasser_minus)(ra1,ra2, ra1,ra2)			<< endl;
	...
	if (ET_anisotropic_cylinder_switch == 1)
	{
		...
		if (my_id == master_id)
		{
			...
			cylinder_ring_to_ring_file << "%% W to W: "							<< endl 
				<< (*cylinder_ring_to_ring_VF_WtoW)(ra1,ra2, ra1,ra2)			<< endl;
			
			cylinder_ring_to_ring_file << "%% U to W: "							<< endl 
				<< (*cylinder_ring_to_ring_VF_UtoW)(ra1,ra2, ra1,ra2)			<< endl;
			
			cylinder_ring_to_ring_file << "%% Zp to Zp: "						<< endl 
				<< (*cylinder_ring_to_ring_Elsasser_plus)(ra1,ra2, ra1,ra2)		<< endl;
			
			cylinder_ring_to_ring_file << "%% Zm to Zm: "						<< endl 
				<< (*cylinder_ring_to_ring_Elsasser_minus)(ra1,ra2, ra1,ra2)	<< endl << endl;
			...
			cylinder_ring_to_ring_file << "%% Force feed (Fw * W): "			<< endl
				<< (*forceW_cylinder_ring)(ra1,ra2)								<< endl;
...
void IncFluid::Output_cylinder_ring_to_ring(IncVF& W, IncSF& T)
{
	...
	if (ET_anisotropic_cylinder_switch == 1)
	{
		...
		if (my_id == master_id)
		{
			...
			cylinder_ring_to_ring_file << "%% Zm to Zm: "						<< endl 
				<< (*cylinder_ring_to_ring_Elsasser_minus)(ra1,ra2, ra1,ra2)	<< endl;
