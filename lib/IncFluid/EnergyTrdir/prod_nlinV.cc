 ...
 * Tarang-4.0 is distriIncFluid::buted in the hope that it will be useful,
 ...
 */
DP IncFluid::Prod_out_sphere_nlinV(int sphere_index)
{
...
DP IncFluid::Prod_out_sphere_nlinV(int sphere_index, IncSF& T)
{
...
DP IncFluid::Prod_out_sphere_nlinV(int sphere_index, IncVF& W)
{
	DP	radius = (*sphere_radius)(sphere_index);				
 ...
 */
DP IncFluid::Prod_in_sphere_nlinV(int sphere_index)
{
	DP	radius = (*sphere_radius)(sphere_index);			// radius of the sphere	
...
DP IncFluid::Prod_in_sphere_nlinV(int sphere_index, IncSF& T)
{
	DP	radius = (*sphere_radius)(sphere_index);			// radius of the sphere	
...
DP IncFluid::Prod_in_sphere_nlinV(int sphere_index, IncVF& W)
{
	DP	radius = (*sphere_radius)(sphere_index);			// radius of the sphere	
...
//*********************************************************************************************
// Helicity flux
DP IncFluid::Prod_out_sphere_nlin_vorticity(int sphere_index)
{
	DP	radius = (*sphere_radius)(sphere_index);			// radius of the sphere	
	...
	// Helicity flux
DP IncFluid::Prod_out_sphere_nlin_vector_potential(int sphere_index, IncVF& W)
{
	DP	radius = (*sphere_radius)(sphere_index);			// radius of the sphere	
