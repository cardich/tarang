...
void IncFluid::Fill_in_sphere(int sphere_index)						
{
...
void IncFluid::Fill_in_sphere(int sphere_index, IncSF& T)						
{
...
void IncFluid::Fill_in_sphere(int sphere_index, IncVF& W)						
{
	DP radius = (*sphere_radius)(sphere_index);				// radius of the sphere
...
void IncFluid::Fill_out_sphere(): -- OUTSIDE SPHERE FILLED
...
void IncFluid::Fill_out_sphere(int sphere_index)						
{
	DP radius = (*sphere_radius)(sphere_index);				// radius of the sphere
...
// For Passive Scalar 
void IncFluid::Fill_out_sphere(int sphere_index, IncSF& T)						
{
	DP radius = (*sphere_radius)(sphere_index);				// radius of the sphere
...
// For MHD 
void IncFluid::Fill_out_sphere(int sphere_index, IncVF& W)						
{
	DP radius = (*sphere_radius)(sphere_index);				// radius of the sphere
...
void IncFluid::Fill_shell(int shell_from_index)						
{
...
// Passive scalar
void IncFluid::Fill_shell(int shell_from_index, IncSF& T)						
{
	DP inner_radius = (*shell_radius)(shell_from_index - 1);
	DP outer_radius = (*shell_radius)(shell_from_index);
...
// MHD B field
void IncFluid::Fill_shell(int shell_from_index, IncVF& W)						
{
	DP inner_radius = (*shell_radius)(shell_from_index - 1);
	DP outer_radius = (*shell_radius)(shell_from_index);
...
void IncFluid::Fill_in_sphere_vorticity(int sphere_index)						
{
	...
	*G3 = 0.0;
	...
	/// Fluid -- fill shell
	/// Include the modes of the outer surface, and exclude that of inner surface.
void IncFluid::Fill_shell_vorticity(int shell_from_index)						
{
