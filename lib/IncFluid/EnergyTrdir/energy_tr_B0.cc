...
void IncFluid::Compute_shell_ET_B0(IncVF& W)
{
	...
	int data_size = 3;
	MPI_Bcast(reinterpret_cast<DP*>(B0.data()), data_size, MPI_DP, 
...
/// Done to compare them with shell-to-shell transfers.
void IncFluid::Compute_ring_ET_B0(IncVF& W)
{
	TinyVector<DP,3> B0;
...
/// Done to compare them with shell-to-shell transfers.
void IncFluid::Compute_cylinder_ring_ET_B0(IncVF& W)
{
