 ...
 */
void IncFluid::ET_Inverse_transform_G(Array<complx,3> temp_r)
{					
...
void IncFluid::ET_Inverse_transform_G_transpose_order(Array<complx,3> temp)
{	
#ifdef TRANSPOSE	
	temp = *G1;
 ...
 * @return Inplace inverse transform of Giver field G.
 */
void IncFluid::ET_Forward_transform_RSprod_G(Array<complx,3> temp_r)
{
 ...
 */
void IncFluid::ET_Forward_transform_RSprod_G_transpose_order(Array<complx,3> temp_r)
{
#ifdef TRANSPOSE
	temp_r = *G1;
