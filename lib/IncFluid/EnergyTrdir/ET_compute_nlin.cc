 ...
 */ 
void IncFluid::EnergyTr_Compute_nlin() 
{  
 ...
 *
 *	Same as void IncFluid::EnergyTr_Compute_nlin() except that here W plays the role of helper
 *		in place of V.
 *
 *  @return \f$ N_i \leftarrow D_j \mathcal{F}(Wr_j * G_i) \f$.
 */
void IncFluid::EnergyTr_Compute_nlin(IncVF& W) 
{
 ...
 */
void IncFluid::EnergyTr_Compute_nlin(IncSF& T) 
{
 ...
 */ 
void IncFluid::EnergyTr_Compute_nlin_vorticity_helper()
{  
	...
	IncFluid::Compute_RSprod_diagET();					
	
	IncFluid::NLIN_diag_Forward_transform_derivative(*VF_temp_r);                     
	
	IncFluid::Compute_RSprod_offdiagET();	
	
	RVF::RV_Forward_transform_RSprod(*VF_temp_r);					// V_i = T[ Hj G_i] 
	
	ET_Forward_transform_RSprod_G(*VF_temp_r);
	
	IncFluid::Derivative_RSprod_VV_ET();	 	
}
 ...
 */ 
void IncFluid::EnergyTr_Compute_nlin_UcrossB()
{  
