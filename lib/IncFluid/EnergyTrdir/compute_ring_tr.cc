...
void IncFluid::Compute_ring_tr(IncSF& T)
{
...
void IncFluid::Compute_ring_tr_scalar(IncSF& T)
{
	// U to U
	Compute_ring_tr();
...
// RBC
void IncFluid::Compute_ring_tr_RB(IncSF& T)
{
...
//	 MHD   
//
void IncFluid::Compute_ring_tr(IncVF& W)
{
	Compute_ring_tr();
	...
	for (int ring_shell_from_i = 1; ring_shell_from_i < no_shells; ring_shell_from_i++) 
		...
		{	
			...
			(*ring_to_ring_VF_WtoW)(ring_shell_from_i, sector_from_i, 
										Range::all(), Range::all()) = -*temp_ring_tr;	
	...
	for (int ring_shell_from_i = 1; ring_shell_from_i < no_shells; ring_shell_from_i++) 
		...
		{	
			...
			(*ring_to_ring_VF_UtoW)(ring_shell_from_i, sector_from_i, 
										Range::all(), Range::all()) = *temp_ring_tr;	
	...
	for (int ring_shell_from_i = 1; ring_shell_from_i < no_shells; ring_shell_from_i++) 
		...
		{	
			...
			(*ring_to_ring_Elsasser_plus)(ring_shell_from_i, sector_from_i, 
										Range::all(), Range::all()) = -*temp_ring_tr;	
	...
	for (int ring_shell_from_i = 1; ring_shell_from_i < no_shells; ring_shell_from_i++) 
		...
		{	
			...
			(*ring_to_ring_Elsasser_minus)(ring_shell_from_i, sector_from_i, 
										Range::all(), Range::all()) = -*temp_ring_tr;	
...
// Vector + Scalar
//
void IncFluid::Compute_ring_tr(IncVF& W, IncSF& T)
{
