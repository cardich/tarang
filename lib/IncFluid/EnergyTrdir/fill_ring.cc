...
// Spherical rings
// Fluid
void IncFluid::Fill_ring(int ring_shell_from_index, int sector_from_index)						
{	
...
void IncFluid::Fill_ring(int ring_shell_from_index, int sector_from_index, IncSF& T)						
{
	DP inner_radius = (*ring_shell_radius)(ring_shell_from_index - 1);
	DP outer_radius = (*ring_shell_radius)(ring_shell_from_index);
...
void IncFluid::Fill_ring(int ring_shell_from_index, int sector_from_index, IncVF& W)						
{
	DP inner_radius = (*ring_shell_radius)(ring_shell_from_index - 1);
	DP outer_radius = (*ring_shell_radius)(ring_shell_from_index);
...
void IncFluid::Fill_cylinder_ring(int cylinder_shell_from_index, int slab_from_index)						
{	
...
void IncFluid::Fill_cylinder_ring(int cylinder_shell_from_index, int slab_from_index, IncSF& T)						
{	
...
void IncFluid::Fill_cylinder_ring(int cylinder_shell_from_index, int slab_from_index, IncVF& W)						
{	
