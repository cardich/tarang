	...
	*forceV_shell = 0.0; 
	...
	{	
		cylinder_ring_to_ring_self = new Array<DP,4>(no_cylinder_shells+1,
													 no_cylinder_kpll_slabs+1, no_cylinder_shells+1,
													 no_cylinder_kpll_slabs+1);
	...
	// FOR SCALAR
	if (globalvar_T_exists_switch == 1) {
	...
	// FOR VECTOR FIELD W
	if (globalvar_W_exists_switch == 1) {
		flux_VF_Win_Wout = new Array<DP,1>(no_shells+1);
		flux_VF_Uin_Win = new Array<DP,1>(no_shells+1);
		flux_VF_Uin_Wout = new Array<DP,1>(no_shells+1);
		flux_VF_Win_Uout = new Array<DP,1>(no_shells+1);
		flux_VF_Uout_Wout = new Array<DP,1>(no_shells+1);
		flux_Elsasser_plus = new Array<DP,1>(no_shells+1);
		flux_Elsasser_minus = new Array<DP,1>(no_shells+1);
		...
		*flux_Elsasser_minus = 0.0;
		...
		flux_Whk = new Array<DP,1>(no_shells+1);
		*flux_Whk = 0.0;
		
		shelltoshell_VF_WtoW = new Array<DP,2>(no_shells+1, no_shells+1);
		shelltoshell_VF_UtoW = new Array<DP,2>(no_shells+1, no_shells+1);
		shelltoshell_Elsasser_plus = new Array<DP,2>(no_shells+1, no_shells+1);
		shelltoshell_Elsasser_minus = new Array<DP,2>(no_shells+1, no_shells+1);
		...
		*shelltoshell_Elsasser_minus = 0.0;
		...
		shelltoshell_Whk = new Array<DP,2>(no_shells+1, no_shells+1);
		*shelltoshell_Whk = 0.0;
		
		forceW_shell = new Array<DP,1>(no_shells+1);
		*forceW_shell = 0.0;
		...
		*energy_tr_shell_B0 = 0.0;
		...
		if (ET_anisotropic_ring_switch == 1)
		{
			ring_to_ring_VF_WtoW	= new Array<DP,4>(no_ring_shells+1, no_sectors_ring_tr+1, 
													  no_ring_shells+1, no_sectors_ring_tr+1);
			
			ring_to_ring_VF_UtoW	= new Array<DP,4>(no_ring_shells+1, no_sectors_ring_tr+1, 
													  no_ring_shells+1, no_sectors_ring_tr+1);
			
			ring_to_ring_Elsasser_plus	= new Array<DP,4>(no_ring_shells+1, no_sectors_ring_tr+1, 
													  no_ring_shells+1, no_sectors_ring_tr+1);
			
			ring_to_ring_Elsasser_minus	= new Array<DP,4>(no_ring_shells+1, no_sectors_ring_tr+1, 
													  no_ring_shells+1, no_sectors_ring_tr+1);
			...
			*ring_to_ring_Elsasser_minus = 0.0; 
			...
			forceW_ring		= new Array<DP,2>(no_ring_shells+1, no_sectors_ring_tr+1);
			*forceW_ring = 0.0;
		...
		if (ET_anisotropic_cylinder_switch == 1)
		{	
			cylinder_ring_to_ring_VF_WtoW = new Array<DP,4>(no_cylinder_shells+1,
													  no_cylinder_kpll_slabs+1, no_cylinder_shells+1,
													  no_cylinder_kpll_slabs+1);
			
			cylinder_ring_to_ring_VF_UtoW = new Array<DP,4>(no_cylinder_shells+1,
													no_cylinder_kpll_slabs+1,no_cylinder_shells+1,
															no_cylinder_kpll_slabs+1);
			
			cylinder_ring_to_ring_Elsasser_plus = new Array<DP,4>(no_cylinder_shells+1,
													no_cylinder_kpll_slabs+1, no_cylinder_shells+1,
															no_cylinder_kpll_slabs+1);
			
			cylinder_ring_to_ring_Elsasser_minus = new Array<DP,4>(no_cylinder_shells+1,
													no_cylinder_kpll_slabs+1, no_cylinder_shells+1,
															no_cylinder_kpll_slabs+1);
			*cylinder_ring_to_ring_VF_WtoW = 0.0;
			*cylinder_ring_to_ring_VF_UtoW = 0.0;
			*cylinder_ring_to_ring_Elsasser_plus = 0.0;
			*cylinder_ring_to_ring_Elsasser_minus = 0.0;
			
			forceW_cylinder_ring = new Array<DP,2>(no_cylinder_shells+1,no_cylinder_kpll_slabs+1);
			*forceW_cylinder_ring = 0.0;
