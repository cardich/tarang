 ...
 */
void IncFluid::Compute_RSprod_diag_ft_derivativeET()
{
#ifdef TRANSPOSE 
 ...
 */
void IncFluid::Compute_RSprod_diag_ft_derivativeET(IncVF& W)
{
#ifdef TRANSPOSE 
 ...
 */
void IncFluid::Forward_transform_derivative_RSprod_offdiagET()
{
#ifdef TRANSPOSE
