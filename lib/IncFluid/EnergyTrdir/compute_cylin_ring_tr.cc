...
void IncFluid::Compute_cylinder_ring_tr()
{
...
void IncFluid::Compute_cylinder_ring_tr(IncSF& T)
{
...
void IncFluid::Compute_cylinder_ring_tr_scalar(IncSF& T)
{
...
// RBC
void IncFluid::Compute_cylinder_ring_tr_RB(IncSF& T)
{
...
//	MHD   
//
void IncFluid::Compute_cylinder_ring_tr(IncVF& W)
{
	...
	for (int cylinder_shell_from_i = 1; cylinder_shell_from_i < no_cylinder_shells; 
		...
		{	
			...
			(*cylinder_ring_to_ring_VF_WtoW)(cylinder_shell_from_i, slab_from_i, 
										Range::all(), Range::all()) = -*temp_cylinder_ring_tr;	
	...
	for (int cylinder_shell_from_i = 1; cylinder_shell_from_i < no_cylinder_shells; 
		...
		{	
			...
			(*cylinder_ring_to_ring_VF_UtoW)(cylinder_shell_from_i, slab_from_i,
										Range::all(), Range::all()) = *temp_cylinder_ring_tr;
	...
	for (int cylinder_shell_from_i = 1; cylinder_shell_from_i < no_cylinder_shells; 
		...
		{	
			...
			(*cylinder_ring_to_ring_Elsasser_plus)(cylinder_shell_from_i, slab_from_i,
										Range::all(), Range::all()) = -*temp_cylinder_ring_tr;	
	...
	for (int cylinder_shell_from_i = 1; cylinder_shell_from_i < no_cylinder_shells; 
		...
		{	
			...
			(*cylinder_ring_to_ring_Elsasser_minus)(cylinder_shell_from_i, slab_from_i,
										Range::all(), Range::all()) = -*temp_cylinder_ring_tr;
...
//	VECTOR + SCALAR   
//
void IncFluid::Compute_cylinder_ring_tr(IncVF& W, IncSF& T)
{
