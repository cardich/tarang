...
{
	*VF_temp = *V1;   
	*V1 =  complex<DP>(0.5,0)*(*V1 + *W.V1);   
	*W.V1 =  complex<DP>(0.5,0)*(*VF_temp - *W.V1);
	 
	*VF_temp = *V2;   
	*V2 =  complex<DP>(0.5,0)*(*V2 + *W.V2);   
	*W.V2 =  complex<DP>(0.5,0)*(*VF_temp - *W.V2); 
	
	*VF_temp = *V3;   
	*V3 =  complex<DP>(0.5,0)*(*V3 + *W.V3);   
	*W.V3 =  complex<DP>(0.5,0)*(*VF_temp - *W.V3);
}
...
{
	*VF_temp = *Force1;   
	*Force1 =  complex<DP>(0.5,0)*(*Force1 + *W.Force1);   
	*W.Force1 =  complex<DP>(0.5,0)*(*VF_temp - *W.Force1); 
	
	*VF_temp = *Force2;   
	*Force2 =  complex<DP>(0.5,0)*(*Force2 + *W.Force2);   
	*W.Force2 =  complex<DP>(0.5,0)*(*VF_temp - *W.Force2); 
	
	*VF_temp = *Force3;   
	*Force3 =  complex<DP>(0.5,0)*(*Force3 + *W.Force3);   
	*W.Force3 =  complex<DP>(0.5,0)*(*VF_temp - *W.Force3);
}
...
{
	*VF_temp = *nlin1;   
	*nlin1 = complex<DP>(0.5,0)*(*nlin1 + *W.nlin1);   
	*W.nlin1 = complex<DP>(0.5,0)*(*VF_temp - *W.nlin1); 
	
	*VF_temp = *nlin2;   
	*nlin2 = complex<DP>(0.5,0)*(*nlin2 + *W.nlin2);   
	*W.nlin2 = complex<DP>(0.5,0)*(*VF_temp - *W.nlin2); 
	
	*VF_temp = *nlin3;   
	*nlin3 = complex<DP>(0.5,0)*(*nlin3 + *W.nlin3);   
	*W.nlin3 = complex<DP>(0.5,0)*(*VF_temp - *W.nlin3); 
}
