		...
		RSF(NN, string_switches, switches, prog_kfactor, misc_output_para) 
{
	...
	shell_spectrum_force_SFk = new Array<DP,1>(CS_shell_ek_size);  
	...
	{
		ring_spectrum_force_SFk = new Array<DP,2>(CS_ring_ek_size, 
	...
	{		
		cylinder_ring_spectrum_force_SFk = new Array<DP,2>(CS_cylinder_shell_ek_size, 
