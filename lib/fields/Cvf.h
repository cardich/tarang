...
public:
	...
	//!  Total energy of Cvf.
	DP		CV_total_E1, CV_total_E2, CV_total_E3;
	DP		CV_total_energy;						
	
	//!  Total dissipation rate of Cvf (without \f$ \nu \f$).
	DP		CV_total_dissipation;	
	DP		CV_total_dissipation_Hc;	
...
public:
	...
	void CV_Compute_totalenergy();
	void CV_Compute_totaldiss();
	void CV_Compute_totaldiss(Array<complx,3> W1, Array<complx,3> W2, Array<complx,3> W3);
